function exportCurrentLungLiverReportToDicomCallback(~, ~)
%function exportCurrentLobeLungReportToDicomCallback()
%Export 3D Lung Liver Report to a DICOM print.
...
% along with TriDFusion.  If not, see <http://www.gnu.org/licenses/>.
    ...
    objectToDicomJpg(sWriteDir, fig3DLungShuntReport, '3DF Lung Shunt', get(uiSeriesPtr('get'), 'Value'))
