function exportCurrentPETLiverDosimetryReportToDicomCallback(~, ~)
%function exportCurrentPETLiverDosimetryReportToDicomCallback()
%Export PET y90 Liver Dosimetry Report to a DICOM print.
...
% along with TriDFusion.  If not, see <http://www.gnu.org/licenses/>.
    ...
    objectToDicomJpg(sWriteDir, figPETLiverDosimetryReport, '3DF Y90 Liver', get(uiSeriesPtr('get'), 'Value'))
