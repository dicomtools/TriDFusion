function setSegmentationPSMACallback(~, ~)
%function setSegmentationPSMACallback()
...
% along with TriDFusion.  If not, see <http://www.gnu.org/licenses/>.
    ...
    function proceedPSMASegmentationCallback(~, ~)
        ...
        setSegmentationPSMA(dBoneMaskThreshold, dBoundaryPercent, dSmalestVoiValue, dPixelEdge); 
    end
