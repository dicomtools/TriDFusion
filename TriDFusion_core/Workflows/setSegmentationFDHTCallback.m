function setSegmentationFDHTCallback(hObject, ~)
...
% along with TriDFusion.  If not, see <http://www.gnu.org/licenses/>.
    ...
    %                   ); 
        ...
        setSegmentationFDHT(FDHTSegmentationBoneMaskThresholdValue('get'), ...
                            FDHTSmalestVoiValue('get'), ...
                            pixelEdge('get'), ...
                            true);        
    end
...
%         dBoundaryPercent   = str2double(get(edtFDHTBoundaryPercentOfMaxValue, 'String'))/100;
        ...
        setSegmentationFDHT(dBoneMaskThreshold, dSmalestVoiValue, dPixelEdge, false); 
    end
