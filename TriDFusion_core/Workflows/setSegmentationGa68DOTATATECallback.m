function setSegmentationGa68DOTATATECallback(hObject, ~)
...
% along with TriDFusion.  If not, see <http://www.gnu.org/licenses/>.
    ...
    if viewerUIFigure('get') == true
        ...
        dlgGa68DOTATATESegmentation = ...
            uifigure('Position', [(getMainWindowPosition('xpos')+(getMainWindowSize('xsize')/2)-DLG_Ga68DOTATATE_PERCENT_X/2) ...
    ...
    edtGa68DOTATATENormalLiverThresholdMultiplierValue = ...
     ...
     uicontrol(dlgGa68DOTATATESegmentation,...
         ...
         setSegmentationGa68DOTATATE(Ga68DOTATATESegmentationBoneMaskThresholdValue('get'), ...
                                     ...
                                     pixelEdge('get'), ...
                                     Ga68DOTATATENormalLiverThresholdMultiplierValue('get'), ...
                                     true); 
...
%         dBoundaryPercent   = str2double(get(edtGa68DOTATATEBoundaryPercentOfMaxValue, 'String'))/100;
        dBoneMaskThreshold= str2double(get(edtGa68DOTATATEBoneMaskThresholdValue, 'String'));
        dNormalLiverThresholdMultiplier = str2double(get(edtGa68DOTATATENormalLiverThresholdMultiplierValue, 'String'));

        delete(dlgGa68DOTATATESegmentation);

        setSegmentationGa68DOTATATE(dBoneMaskThreshold, dSmalestVoiValue, dPixelEdge, dNormalLiverThresholdMultiplier, false); 
    end
