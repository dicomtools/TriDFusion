function importDoseRadionuclideCallback(~, ~)
%function importDoseRadionuclideCallback(~, ~)
%Import .xlsx Radionuclide to .mat.
...
%        javaFrame.setFigureIcon(javax.swing.ImageIcon(sLogo));
    ...
    [tDoseRadionuclide, sConvertedMatFile] = xlsxToRadionuclideMat([sKernelPath sFileName]);

    if isempty(tDoseRadionuclide)
