function [dMipAlphaOffset, sMipMapSliderEnable] = ui3DPanelGetMipAlphaMapType(sType, atMetaData)
%function aObject = ui3DPanelGetMipAlphaMapType(sAction, aValue)
%Get 3D Panel Mip Alphamap Type.
