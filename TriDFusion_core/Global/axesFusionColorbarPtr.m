function aObject = axesFusionColorbarPtr(sAction, aValue, iOffset)
%function aObject = axesColorbarPtr(sAction, aValue, iOffset)
%Get\Set Axe Fusion Colorbar Pointer.
