...
% along with TriDFusion.  If not, see <http://www.gnu.org/licenses/>.
    ...
    persistent pbApplyMovement;
    persistent paAxe;
    persistent paPosition;
    
    if strcmpi(sAction, 'set')
        
        pbApplyMovement = bApplyMovementValue;
        ...
        if exist('aPositionValue', 'var')
            paPosition = aPositionValue;
        end          
        
    end
    
    bApplyMovement = pbApplyMovement;
    aAxe           = paAxe;
    aPosition      = paPosition;
