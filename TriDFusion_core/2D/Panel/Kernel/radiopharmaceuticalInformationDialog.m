...
% along with TriDFusion.  If not, see <http://www.gnu.org/licenses/>.
    ...
    if viewerUIFigure('get') == true
        ...
        dlgInformation = ...
            uifigure('Position', [(getMainWindowPosition('xpos')+(getMainWindowSize('xsize')/2)-420/2) ...
    ...
    axeInformation.Toolbar.Visible = 'off';
    disableDefaultInteractivity(axeInformation);
