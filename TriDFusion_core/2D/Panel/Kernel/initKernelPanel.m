...
%    addlistener(uiSliderKernelUpperTreshold,'Value','PreSet',@sliderKernelUpperTreshCallback);
    ...
    editKernelVoiRoiUpperTresholdObject('set', uiEditKernelUpperTreshold);
        ...
        uicontrol(uiKernelPanelPtr('get'),...
                  ...
                  'BackgroundColor', viewerBackgroundColor('get'), ...
                  'ForegroundColor', viewerForegroundColor('get'), ...
                  'position', [15 330 200 20]...
                  );

    uiSliderKernelLowerTreshold = ...
        uicontrol(uiKernelPanelPtr('get'), ...
                  'Style'   , 'Slider', ...
                  'Position', [15 315 175 14], ...
...
%    lstSliderKernelLowerTresh = addlistener(uiSliderKernelLowerTreshold,'Value','PreSet',@sliderKernelLowerTreshCallback);
    ...
    editKernelVoiRoiLowerTresholdObject('set', uiEditKernelLowerTreshold);
         ...
         uicontrol(uiKernelPanelPtr('get'),...
                  ...
                  'BackgroundColor', viewerBackgroundColor('get'), ...
                  'ForegroundColor', viewerForegroundColor('get'), ...
                  'position', [15 282 125 20]...
                  );

    uiKernelModel = ...
        uicontrol(uiKernelPanelPtr('get'), ...
                  'Style'   , 'popup', ...
                  'position', [135 285 125 20],...
                  'String'  , ' ', ...
                  'Value'   , 1,...
                  'Enable'  , sEnable, ...
                  'BackgroundColor', viewerBackgroundColor('get'), ...
   ...
   if ~isempty(tDoseKernel)
     set(uiKernelModel, 'String', tDoseKernel.ModelName);
         ...
         uicontrol(uiKernelPanelPtr('get'),...
                  ...
                  'BackgroundColor', viewerBackgroundColor('get'), ...
                  'ForegroundColor', viewerForegroundColor('get'), ...
                  'position', [15 257 125 20]...
                  );

    uiKernelTissue = ...
        uicontrol(uiKernelPanelPtr('get'), ...
                  'Style'   , 'popup', ...
                  'position', [135 260 125 20],...
                  'String'  , ' ', ...
                  'Value'   , 1,...
                  'Enable'  , sEnable, ...
                  'BackgroundColor', viewerBackgroundColor('get'), ...
...
%            javaFrame.setFigureIcon(javax.swing.ImageIcon(sLogo));
        ...
        function setDoseKernel()
            ...
            if kernelMicrosphereInSpecimen('get') == true
               ...
               tDoseInformation = radiopharmaceuticalInformationDialog(); 
               
                if isempty(tDoseInformation)
                    return;
                else 
                    dPixelSpacingX = tDoseInformation.dPixelSpacingX;     
                    dPixelSpacingY = tDoseInformation.dPixelSpacingY;          
                    dPixelSpacingZ = tDoseInformation.dPixelSpacingZ;      
                    
                    sSeriesDate = tDoseInformation.sCallibrationDate;
                    sSeriesTime = tDoseInformation.sCallibrationTime;
                    
                    sRadiopharmaceuticalStartDate = tDoseInformation.sInfusionDate;
                    sRadiopharmaceuticalStartTime = tDoseInformation.sInfusionTime;            
                    
                    sRadionuclideHalfLife = tDoseInformation.sHalfLife;            
                    sRadiopharmaceutical = tDoseInformation.sTreatmentType;                         
