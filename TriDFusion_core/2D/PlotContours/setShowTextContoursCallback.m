...
% along with TriDFusion.  If not, see <http://www.gnu.org/licenses/>.
    ...
    if size(dicomBuffer('get', [], get(uiSeriesPtr('get'), 'Value')), 3) == 1 % 2D Image
        ...
        if viewerUIFigure('get') == true
            ...
            dlgShowTextList = ...
                uifigure('Position', [(getMainWindowPosition('xpos')+(getMainWindowSize('xsize')/2)-380/2) ...
                       ...
                       'WindowStyle', 'modal', ...
                       'Name'       , 'Plot Contours Display Text'...
                       );
        else
        ...
        setObjectIcon(dlgShowTextList);
       
        aDlgPosition = get(dlgShowTextList, 'Position');
        ...
        axeShowTextList = ...      
         ...
         axeShowTextList.Interactions = [];
         deleteAxesToolbar(axeShowTextList);
         disableDefaultInteractivity(axeShowTextList);
