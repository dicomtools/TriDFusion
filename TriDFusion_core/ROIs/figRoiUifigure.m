function figRoiUifigure(hObject)
%function figRoiUifigure(hObject)
...
% along with TriDFusion.  If not, see <http://www.gnu.org/licenses/>.
    ...
    figRoiWindow = ...
        uifigure('Position', [(getMainWindowPosition('xpos')+(getMainWindowSize('xsize')/2)-FIG_ROI_X/2) ...
    ...
    %      axes(figRoiWindow, ...
    %          'Units'   , 'pixels', ...
    %          'Position', get(figRoiWindow, 'Position'), ...
    ...
    %          'Visible' , 'off'...
    %          );
    % dummyAxe.Interactions = [];
    % dummyAxe.Toolbar.Visible = 'off';
    % disableDefaultInteractivity(dummyAxe);

    sRootPath = viewerRootPath('get');

    if ~isempty(sRootPath)

        figRoiWindow.Icon = fullfile(sRootPath, 'logo.png');
    end
    ...
    uimenu(mRoiEdit,'Label', 'Copy Display', 'Callback', @copyRoiUifigureDisplayCallback);
...
%                         );
    ...
    if isFigRoiInColor('get') == true
        aBackgroundColor =viewerBackgroundColor ('get');
    else
    ...
    pause(0.01); % gives GUI thread a moment to catch up

    lbVoiRoiWindow = uilistbox(uiVoiRoiWindow, ...
        'Position'        , [0 0 uiVoiRoiWindow.Position(3) uiVoiRoiWindow.Position(4)-20], ...
        'Items'           , {''}, ...
        'FontSize'        , 13, ...
        'FontWeight'      , 'bold', ...
        ...
        'FontName'        , 'Monospaced', ...
        'Multiselect'     , 'on', ...
        'DoubleClickedFcn', @lbMainWindowCallback);
    ...
    function roiClickDown(~, ~)
        ...
        if strcmp(get(figRoiWindow,'selectiontype'),'alt')
            ...
            if ~isempty(aVoiRoiTag) || ~isempty(atRoiInput)
                ...
                adOffset = get(lbVoiRoiWindow, 'ValueIndex');

                % asRoiWindow = cellstr(get(lbVoiRoiWindow, 'String'));
                asRoiWindow = lbVoiRoiWindow.Items;
...
%                         end
                    ...
                    bIsVoiTag= false;
                    if ~isempty(atVoiInput)
                        aTagOffset = strcmp( cellfun( @(atVoiInput) atVoiInput.Tag, atVoiInput, 'uni', false ), {aVoiRoiTag{get(lbVoiRoiWindow, 'ValueIndex')}.Tag} );
                    ...
                    mFigRoiConstraint = ...
                        uimenu(c, ...
                               'Label'    , 'Constraint' , ...
                               'UserData' , aVoiRoiTag{get(lbVoiRoiWindow, 'ValueIndex')}.Tag, ...
                    ...
                    if size(dicomBuffer('get', [], get(uiSeriesPtr('get'), 'Value')), 3) ~= 1 % 3D Image
                        ...
                        if (isfield(atMetaData{1}, 'SeriesType') && contains(lower(atMetaData{1}.SeriesType), 'dynamic')) || (gateUseSeriesUID('get') == false)
                    ...
                    if ~isempty(atRoiInput)
                        for dd=1:numel(atRoiInput)
                            if isvalid(atRoiInput{dd}.Object)
                                if strcmpi(atRoiInput{dd}.Tag, aVoiRoiTag{get(lbVoiRoiWindow, 'ValueIndex')}.Tag)
                ...
                if bDispayMenu == true
                    ...
                    uimenu(c,'Label', 'Edit Color', 'Callback',@figRoiEditMultipleColorCallback);
    ...
    %                 lbVoiRoiWindow.UIContextMenu = [];
        ...
        function figRoiEditIncrementRatioVoiPositionCallback(~, ~)
            ...
            if viewerUIFigure('get') == true
                ...
                dlgIncrement = ...
                    uifigure('Position', [(getMainWindowPosition('xpos')+(getMainWindowSize('xsize')/2)-DLG_INCREAMENT_X/2) ...
            ...
            if ~isempty(atVoiInput) && ...
               ~isempty(aVoiRoiTag)
                for aa=1:numel(atVoiInput)
                    if strcmp(atVoiInput{aa}.Tag, aVoiRoiTag{get(lbVoiRoiWindow, 'ValueIndex')}.Tag)
               ...
               ~isempty(aVoiRoiTag)
                ...
                for cc=1:numel(atRoiInput)
                    if isvalid(atRoiInput{cc}.Object)
                        if strcmp(atRoiInput{cc}.Tag, aVoiRoiTag{get(lbVoiRoiWindow, 'ValueIndex')}.Tag)
        ...
        function figRoiEditMultipleLesionTypeCallback(hObject, ~)
            ...
            asTag = asTag(get(lbVoiRoiWindow, 'ValueIndex'));
        ...
        function figRoiMultiplePlotCallback(hObject, ~)
            ...
            atVoiRoiTag = aVoiRoiTag(get(lbVoiRoiWindow, 'ValueIndex'));
        ...
        function figRoiDeleteObjectCallback(~, ~)
            ...
            if ~isempty(aVoiRoiTag)
                ...
                figRoiDeleteObject(aVoiRoiTag{lbVoiRoiWindow.ValueIndex}.Tag, true);
            end
        end
        ...
        function figRoiPredefinedLabelCallback(hObject, ~)
            ...
            if ~isempty(aVoiRoiTag)
                ...
                if isempty(atVoiInput)
                    ...
                    aTagOffset = strcmp( cellfun( @(atVoiInput) atVoiInput.Tag, atVoiInput, 'uni', false ), {aVoiRoiTag{lbVoiRoiWindow.ValueIndex}.Tag} );
                end
                ...
                if aTagOffset(aTagOffset==1) % tag is a voi
                    ...
                    if isempty(atRoiInput)
                        ...
                        aTagOffset = strcmp( cellfun( @(atRoiInput) atRoiInput.Tag, atRoiInput, 'uni', false ), {aVoiRoiTag{lbVoiRoiWindow.ValueIndex}.Tag} );
                    end
            ...
            function figRoiEditLabelDialog(ptrObject)
                ...
                if viewerUIFigure('get') == true
                    ...
                    figRoiEditLabelWindow = ...
                        uifigure('Position', [(figRoiPosX+(figRoiSizeX/2)-EDIT_DIALOG_X/2) ...
                ...
                setObjectIcon(figRoiEditLabelWindow);
        ...
        function figRoiEditMultipleColorCallback(~, ~)

            sColor = uisetcolor('Select a color');
            ...
            for jj=1:dNbTags
                ...
                dTagOffset = find(strcmp( cellfun( @(atVoiInput) atVoiInput.Tag, atVoiInput, 'uni', false ), asTag(jj) ), 1);
                ...
                if ~isempty(dTagOffset) % tag is a VOI
                    ...
                    dTagOffset = find(strcmp( cellfun( @(atRoiInput) atRoiInput.Tag, atRoiInput, 'uni', false ), asTag(jj) ), 1);
...
%                         end
                        ...
                        if isFigRoiInColor('get') == true
                            ...
                            acStyleArray{end+1} = uistyle(FontColor=atVoiInput{aa}.Color);
                        end

                        % scLbWindow = sprintf('%s%s\n', scLbWindow, sLine);
                        scLbWindow = [scLbWindow, {sLine}];  % Append the new line to the cell array

                        aVoiRoiTag{end+1}.Tag = atVoiInput{aa}.Tag;
    ...
    %                                 end
                                    ...
                                    sLine = sprintf('%-18s %-11s %-12s %-12s %-12s %-12s %-12s %-12s %-12s %-12s %-12s %-12s %-12s %-12s %-12s', ...
                                     ...
                                     if isFigRoiInColor('get') == true
                                        ...
                                        acStyleArray{end+1} = uistyle(FontColor=atRoiComputed{bb}.Color);
                                    end
                                     ...
                                     aVoiRoiTag{end+1}.Tag = atRoiComputed{bb}.Tag;
...
%               if isvalid(atRoiInput{bb}.Object)
                    if strcmpi(atRoiInput{bb}.ObjectType, 'roi')
                        ...
                        if isFigRoiInColor('get') == true
                            ...
                            % sColor = reshape(dec2hex([int32(aColor(1)*255) int32(aColor(2)*255) int32(aColor(3)*255)], 2)',1, 6);
                            % sLine = sprintf('<HTML><FONT color="%s" face="%s">%s', sColor, sFontName, sLine);
                            acStyleArray{end+1} = uistyle(FontColor=atRoiInput{bb}.Color);
                        end

                        % scLbWindow = sprintf('%s%s\n', scLbWindow, sLine);
                        scLbWindow = [scLbWindow, {sLine}];  % Append the new line to the cell array

                        aVoiRoiTag{end+1}.Tag = atRoiInput{bb}.Tag;
...
%               end
        ...
        if isvalid(lbVoiRoiWindow)
            ...
            % dListboxValue = get(lbVoiRoiWindow, 'ValueIndex');

            % set(lbVoiRoiWindow, 'ValueIndex', 1);

            set(lbVoiRoiWindow, 'Items', scLbWindow);

            if isFigRoiInColor('get') == true

                if length(acStyleArray) > 1

                    for bb = 1:length(acStyleArray)

                        addStyle(lbVoiRoiWindow, acStyleArray{bb}, 'item', bb);
                    end
                end
            end
            ...
            %     set(lbVoiRoiWindow, 'ValueIndex', dListboxValue);
            %     % set(lbVoiRoiWindow, 'ListboxTop', dListboxTop);
            %
            % else
            %     set(lbVoiRoiWindow, 'ValueIndex', size(lbVoiRoiWindow.String, 1));
            ...
            for aa=1:dNbVois
                ...
                if ~isempty(atVoiInput{aa}.RoisTag)
                    ...
                    if ~isempty(tVoiComputed)
                        ...
                        aVoiTag{end+1}.Tag = atVoiInput{aa}.Tag;
    ...
    function copyRoiUifigureDisplayCallback(~, ~)

        try
            set(figRoiWindow, 'Pointer', 'watch');
            drawnow;

            copyFigureToClipboard(figRoiWindow);

        catch ME
            logErrorToFile(ME);
            progressBar(1, 'Error:copyRoiUifigureDisplayCallback()');
        end
    ...
    function lbMainWindowCallback(hObject, ~)
        ...
        if ~isempty(atVoiInput) && ...
           ~isempty(aVoiRoiTag) && ...
           isscalar(hObject.ValueIndex)

            if numel(aVoiRoiTag) <  hObject.ValueIndex
                return;
            end
            ...
            dTagOffset = find(strcmp( cellfun( @(atVoiInput) atVoiInput.Tag, atVoiInput, 'uni', false ), aVoiRoiTag{hObject.ValueIndex}.Tag ), 1);
...
%             end
        ...
        if ~isempty(atRoiInput) && ...
           ...
           isscalar(hObject.ValueIndex)
            ...
            dTagOffset = find(strcmp( cellfun( @(atRoiInput) atRoiInput.Tag, atRoiInput, 'uni', false ), aVoiRoiTag{hObject.ValueIndex}.Tag ), 1);
...
%             end
                ...
                for aa=1:numel(atVoiInput)
                    ...
                    if ~isempty(atVoiInput{aa}.RoisTag)
                        ...
                        if isFigRoiInColor('get') == true
                            ...
                            acStyleArray{end+1} = uistyle(FontColor=[0 0 0]);
                        end
    ...
    function figRoiCopyObjectCallback(hObject, ~)
        ...
        if ~isempty(aVoiRoiTag)
            ...
            figRoiCopyObject(aVoiRoiTag{get(lbVoiRoiWindow, 'ValueIndex')}.Tag, sCopyTo);
        end
    end
    ...
    function figRoiDeleteMultipleObjectsCallback(~, ~)
        ...
        for ii=1:numel(lbVoiRoiWindow.ValueIndex)

            if ~isempty(atVoiInput)

                if isempty(find(strcmp( cellfun( @(atVoiInput) atVoiInput.Tag, atVoiInput, 'uni', false ), aVoiRoiTag{lbVoiRoiWindow.ValueIndex(ii)}.Tag ), 1)) % Tag is not a VOI

                    if ~isempty(find(strcmp( cellfun( @(atRoiInput) atRoiInput.Tag, atRoiInput, 'uni', false ), aVoiRoiTag{lbVoiRoiWindow.ValueIndex(ii)}.Tag ), 1)) % ROI tag exist

                        figRoiDeleteObject(aVoiRoiTag{lbVoiRoiWindow.ValueIndex(ii)}.Tag, false);
                    end
                end
            else
                if ~isempty(atRoiInput)
        ...
        for ii=1:numel(lbVoiRoiWindow.ValueIndex) % Delete all VOI
            if ~isempty(atVoiInput)
            ...
            if ~isempty(atVoiInput)
                ...
                if isempty(find(strcmp( cellfun( @(atVoiInput) atVoiInput.Tag, atVoiInput, 'uni', false ), aVoiRoiTag{lbVoiRoiWindow.ValueIndex(ii)}.Tag ), 1)) % Tag is not a VOI
                    ...
                    if ~isempty(find(strcmp( cellfun( @(atRoiInput) atRoiInput.Tag, atRoiInput, 'uni', false ), aVoiRoiTag{lbVoiRoiWindow.ValueIndex(ii)}.Tag ), 1)) % ROI tag exist
                        ...
                        for ll=1:numel(lbVoiRoiWindow.ValueIndex)

                            dVoiOffset = find(strcmp( cellfun( @(atVoiInput) atVoiInput.Tag, atVoiInput, 'uni', false ), aVoiRoiTag{lbVoiRoiWindow.ValueIndex(ll)}.Tag ), 1);

                            if ~isempty(dVoiOffset) % VOI exist

                                if ~isempty(find(contains(atVoiInput{dVoiOffset}.RoisTag, aVoiRoiTag{lbVoiRoiWindow.ValueIndex(ii)}.Tag), 1))
                        ...
                        if bObjectIsPartOfACopiedVOI == false
                            ...
                            figRoiCopyObject(aVoiRoiTag{lbVoiRoiWindow.ValueIndex(ii)}.Tag, sCopyTo);
                        end
                    end
                end
            else
        ...
        for ii=1:numel(lbVoiRoiWindow.ValueIndex)
            ...
            if ~isempty(atVoiInput) && ...
               ~isempty(aVoiRoiTag)
                ...
                for aa=1:numel(atVoiInput)
                    if strcmpi(atVoiInput{aa}.Tag, aVoiRoiTag{lbVoiRoiWindow.ValueIndex(ii)}.Tag)
                        % Object is a VOI
            ...
            if ~isempty(atRoiInput) && ...
               ~isempty(aVoiRoiTag)
                ...
                for cc=1:numel(atRoiInput)
                    if isvalid(atRoiInput{cc}.Object)
                        if strcmpi(atRoiInput{cc}.Tag, aVoiRoiTag{lbVoiRoiWindow.ValueIndex(ii)}.Tag)
                            % Object is a ROI
