function addRoiToTemplate(iOffset, sAxe, dSliceNb, sType, aPosition, sLabel, sLabelVisible, aColor, dLineWidth, dTag, dRadius, dSemiAxes)
%function addRoiToTemplate(ptrRoi, iOffset)
