function setMachineLearningFDGBrownFatPETCTFullAICESUVRTstructCallback(~, ~)
%function setMachineLearningFDGBrownFatPETCTFullAISUVRTstructCallback()
%Run FDG Brown Fat CE Loss PET SUV Segmentation, The tool is called from the main menu.
...
if 1
    writeBrownFatRTStruct('PET\CT');
else
    % Export RT-structure
    writeRTStructCallback();
end
    writeBrownFatRoisToDicomMask('PET\CT');
