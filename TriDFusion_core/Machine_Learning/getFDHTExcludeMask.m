function aExcludeMask = getFDHTExcludeMask(tFDHT, sSegmentationFolderName, aExcludeMask)
%function aExcludeMask = getFDHTExcludeMask(tFDHT, sSegmentationFolderName, aExcludeMask)
...
% along with TriDFusion.  If not, see <http://www.gnu.org/licenses/>.
    ...
    if tFDHT.exclude.organ.brain == true
    ...
    if tFDHT.exclude.organ.spleen == true
    ...
    if tFDHT.exclude.organ.kidneyLeft == true
    ...
    if tFDHT.exclude.organ.kidneyRight == true
    ...
    if tFDHT.exclude.gastrointestinal.urinaryBladder == true
    ...
    if tFDHT.exclude.gastrointestinal.smallBowel == true
