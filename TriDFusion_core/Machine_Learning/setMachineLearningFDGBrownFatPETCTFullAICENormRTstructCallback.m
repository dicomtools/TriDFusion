function setMachineLearningFDGBrownFatPETCTFullAICENormRTstructCallback(~, ~)
%function setMachineLearningFDGBrownFatPETCTFullAICENormRTstructCallback()
%Run FDG Brown Fat CE Loss PET SUV Normalize Segmentation, The tool is called from the main menu.
