function setMachineLearningPSMALu177DataPreProcessingSPECTCallback(hObject, ~)
%function setMachineLearningPSMALu177DataPreProcessingSPECTCallback(hObject)
%PSMA Lu177 AI SPECT Data Pre-processing, The tool is called from the main menu.
