function aExcludeMask = getLu177ExcludeMask(tLu177, sSegmentationFolderName, aExcludeMask)
%function aExcludeMask = getLu177ExcludeMask(tLu177, sSegmentationFolderName, aExcludeMask)
...
% along with TriDFusion.  If not, see <http://www.gnu.org/licenses/>.
    ...
    if tLu177.exclude.organ.brain == true
    ...
    if tLu177.exclude.organ.spleen == true
    ...
    if tLu177.exclude.organ.kidneyLeft == true
    ...
    if tLu177.exclude.organ.kidneyRight == true
    ...
    if tLu177.exclude.gastrointestinal.urinaryBladder == true
    ...
    if tLu177.exclude.gastrointestinal.smallBowel == true
