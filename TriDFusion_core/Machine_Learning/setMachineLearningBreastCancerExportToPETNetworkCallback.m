function setMachineLearningBreastCancerExportToPETNetworkCallback(hObject, ~)
%function setMachineLearningBreastCancerExportToPETNetworkCallback(hObject)
%Export Metastatic Breast Cancer PET series and contours to a AI trainning network, The tool is called from the main menu.
