function setMachineLearningFDGBrownFatPETCTFullAINormRTstructCallback(~, ~)
%function setMachineLearningFDGBrownFatPETCTFullAINormRTstructCallback()
%Run FDG Brown Fat PET SUV Normalize Segmentation, The tool is called from the main menu.
...
% along with TriDFusion.  If not, see <http://www.gnu.org/licenses/>.
    ...
    machineLearningFDGBrownFatCELoss('set', false);
