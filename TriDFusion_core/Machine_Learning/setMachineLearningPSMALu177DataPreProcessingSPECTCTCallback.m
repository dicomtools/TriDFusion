function setMachineLearningPSMALu177DataPreProcessingSPECTCTCallback(hObject, ~)
%function setMachineLearningPSMALu177DataPreProcessingSPECTCTCallback(hObject)
%PSMA Lu177 SPECT\CT Data Pre-processing, The tool is called from the main menu.
