function setMachineLearningBreastCancerDataPreProcessingPETCallback(hObject, ~)
%function setMachineLearningBreastCancerDataPreProcessingPETCallback(hObject)
%Metastatic Breast Cancer Data Pre-processing, The tool is called from the main menu.
