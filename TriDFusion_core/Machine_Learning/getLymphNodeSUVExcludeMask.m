function aExcludeMask = getLymphNodeSUVExcludeMask(tLymphNodeSUV, sSegmentationFolderName, aExcludeMask)
%function aExcludeMask = getLymphNodeSUVExcludeMask(tLymphNodeSUV, sSegmentationFolderName, aExcludeMask)
...
% along with TriDFusion.  If not, see <http://www.gnu.org/licenses/>.
    ...
    if tLymphNodeSUV.exclude.organ.brain == true
    ...
    if tLymphNodeSUV.exclude.organ.kidneyLeft == true
    ...
    if tLymphNodeSUV.exclude.organ.kidneyRight == true
    ...
    if tLymphNodeSUV.exclude.gastrointestinal.urinaryBladder == true
    ...
    if tLymphNodeSUV.exclude.gastrointestinal.smallBowel == true
