  ...
  edtCropValue = ...
     ...
     function set3DEngineCallback(hObject, ~)
        ...
        if get(chk3DEngine, 'Value') == 1
            ...
            set(txtShading, 'Enable', 'Inactive');
        else
            set(chkShading, 'Enable', 'off');
            set(txtShading, 'Enable', 'off');
        end
