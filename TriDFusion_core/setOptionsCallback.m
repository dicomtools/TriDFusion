...
% along with TriDFusion.  If not, see <http://www.gnu.org/licenses/>.
    ...
    dlgOptions = ...
        dialog('Position', [(getMainWindowPosition('xpos')+(getMainWindowSize('xsize')/2)-FIG_OPTIONS_X/2) ...
                            (getMainWindowPosition('ypos')+(getMainWindowSize('ysize')/2)-FIG_OPTIONS_Y/2) ...
                            FIG_OPTIONS_X ...
                            FIG_OPTIONS_Y ...
                            ],...
               'MenuBar', 'none',...
        ...
        axes(dlgOptions, ...
             'Units'   , 'pixels', ...
             'Position', [0 0 FIG_OPTIONS_X FIG_OPTIONS_Y], ...
             'Color'   , viewerBackgroundColor('get'),...
