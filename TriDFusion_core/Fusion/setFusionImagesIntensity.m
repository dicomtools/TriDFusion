...
% along with TriDFusion.  If not, see <http://www.gnu.org/licenses/>.
    ...
    if isFusion('get') == true
        ...
        if isCombineMultipleFusion('get') == true
            ...
            aFusionBuffer    = cell(gdNbFusedSeries,1);
            aMipFusionBuffer = cell(gdNbFusedSeries,1);
        ...
        if viewerUIFigure('get') == true
           ...
           dlgImagesIntensity = ...
                uifigure('Position', [(getMainWindowPosition('xpos')+(getMainWindowSize('xsize')/2)-465/2) ...
         ...
         axeImagesIntensity.Interactions = [zoomInteraction regionZoomInteraction rulerPanInteraction];
         axeImagesIntensity.Toolbar.Visible = 'off';
         disableDefaultInteractivity(axeImagesIntensity);
...
%          addlistener(uiSliderFusionRedIntensity, 'Value', 'PreSet', @sliderFusionRedIntensityCallback);
         addlistener(uiSliderFusionRedIntensity, 'ContinuousValueChange', @sliderFusionRedIntensityCallback);
...
%          addlistener(uiSliderFusionGreenIntensity, 'Value', 'PreSet', @sliderFusionGreenIntensityCallback);
         addlistener(uiSliderFusionGreenIntensity, 'ContinuousValueChange', @sliderFusionGreenIntensityCallback);
...
%          addlistener(uiSliderFusionBlueIntensity, 'Value', 'PreSet', @sliderFusionBlueIntensityCallback);
         addlistener(uiSliderFusionBlueIntensity, 'ContinuousValueChange', @sliderFusionBlueIntensityCallback);
...
%         addlistener(uiSliderFusionRGBIntensity, 'Value', 'PreSet', @sliderFusionRGBIntensityCallback);
         addlistener(uiSliderFusionRGBIntensity, 'ContinuousValueChange', @sliderFusionRGBIntensityCallback);
