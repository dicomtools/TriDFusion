...
% along with TriDFusion.  If not, see <http://www.gnu.org/licenses/>.
    ...
    try
        ...
        deleteObject(voiRoiSegObject('get'));
        deleteObject(voiRoiActObject('get'));

        deleteObject(chkVoiRoiSubstractObject('get'));

        deleteObject(editVoiRoiUpperTresholdObject  ('get'));
        deleteObject(sliderVoiRoiUpperTresholdObject('get'));
        deleteObject(txtVoiRoiUpperTresholdObject   ('get'));
