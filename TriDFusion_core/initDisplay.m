...
%        uistack(axer, 'top');            
  ...
  %                   'Position'       , [aUiCorPosition(3)-30 aUiCorPosition(4)-30 30 25], ...
  %                   'Enable'         , 'on', ...
  %                   'String'         , 'FS',...
  %                   'BackgroundColor', viewerBackgroundColor('get'), ...
  %                   'ForegroundColor', viewerForegroundColor('get'), ...
 ...
 %                    'Position'       , [aUiSagPosition(3)-30 aUiSagPosition(4)-30 30 25], ...
 %                    'Enable'         , 'on', ...
 %                    'String'         , 'FS',...
 %                    'BackgroundColor', viewerBackgroundColor('get'), ...
 %                    'ForegroundColor', viewerForegroundColor('get'), ...
...
%                     'Position'       , [aUiTraPosition(3)-85 aUiTraPosition(4)-30 30 25], ...
%                     'Enable'         , 'on', ...
%                     'String'         , 'FS',...
%                    'BackgroundColor', viewerBackgroundColor('get'), ...
%                     'ForegroundColor', viewerForegroundColor('get'), ...
