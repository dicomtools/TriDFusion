...
% along with TriDFusion.  If not, see <http://www.gnu.org/licenses/>.
    ...
    if size(dicomBuffer('get'), 3) ~= 1 && ...
       ...
       switchToMIPMode('get')     == false
        ...
        if ~isempty(mGate) && mGate.UserData.isSelected == true
            ...
            switch pAxe
                ...
                case axes1Ptr('get', [], dSeriesOffset)
                    ...
                    set(uiSliderCorPtr('get'), 'Value', sliceNumber('get', 'coronal') );
                ...
                case axes2Ptr('get', [], dSeriesOffset)
                    ...
                    set(uiSliderSagPtr('get'), 'Value', sliceNumber('get', 'sagittal') );

                case {axes3Ptr('get', [], dSeriesOffset), ...
                      axesMipPtr('get', [], dSeriesOffset)}
                    ...
                    set(uiSliderTraPtr('get'), 'Value',  round(aImageSize(3) - sliceNumber('get', 'axial') + 1));
