function viewerSetFullScreenIcon()
%function viewerSetFullScreenIcon()
%The function set the icon image.
...
% along with TriDFusion.  If not, see <http://www.gnu.org/licenses/>.
    ...
    viewerFullScreenIconBlack('set', aImgFullScreenIcon);
    ...
    viewerFullScreenIconWhite('set', aImgFullScreenIcon);
    ...
    viewerExitFullScreenIconBlack('set', aImgFullScreenIcon);
    ...
    viewerExitFullScreenIconWhite('set', aImgFullScreenIcon);
end